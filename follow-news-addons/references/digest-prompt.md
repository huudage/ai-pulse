...
This contract applies to KOL, non-GitHub topic, Blog Picks, and Podcast items. It does not apply to GitHub Releases or GitHub Trending.
...
```
---
📊 Data Sources: RSS {{rss}} | Twitter {{twitter}} | Web {{web}} | GitHub {{github}} releases + {{trending}} trending | Podcast {{podcast}} episodes | Dedup: {{merged}} articles
🤖 Generated by ai-pulse v<VERSION> | <https://github.com/huudage/ai-pulse> | Powered by OpenClaw
```
