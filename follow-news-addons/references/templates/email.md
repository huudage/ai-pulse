...
<div style="max-width:640px;margin:0 auto;font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',Roboto,sans-serif;color:#1a1a1a;line-height:1.6">
  ...
  <p style="font-size:12px;color:#888">
    📊 Data Sources: RSS {{rss_count}} | Twitter {{twitter_count}} | Web {{web_count}} | GitHub {{github_count}} releases | After dedup: {{merged_count}} articles
    <br>🤖 Generated by <a href="https://github.com/huudage/ai-pulse" style="color:#0969da">ai-pulse</a> v{{version}} | Powered by <a href="https://openclaw.ai" style="color:#0969da">OpenClaw</a>
  </p>
...
This applies to KOL, non-GitHub topic, Blog Picks, and Podcast items. GitHub Releases and GitHub Trending keep their existing concise style.
...
<div style="max-width:640px;margin:0 auto;font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',Roboto,sans-serif;color:#1a1a1a;line-height:1.6">
  ...
  <hr style="border:none;border-top:1px solid #e5e5e5;margin:24px 0">
  <p style="font-size:12px;color:#888">
    📊 Data Sources: RSS 287 | Twitter 71 | Web 60 | GitHub 29 releases | After dedup: 140 articles
    <br>Generated by Follow News
  </p>
