...
---
📊 Data Sources: RSS {{rss_count}} | Twitter {{twitter_count}} | Web {{web_count}} | GitHub {{github_count}} releases + {{trending_count}} trending | After dedup: {{merged_count}} articles
...
---
📊 Data Sources: RSS 285 | Twitter 67 | Web 60 | GitHub 29 releases + 33 trending | After dedup: 95 articles
```
